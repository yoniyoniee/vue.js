      ...
      <div class="preview">
        ...
        <CollapsibleSection>
          <div class="preview-content">
            <div class="top-row">
              <img :src="selectedRobot.head.src" alt="face/"/>
            </div>
            <div class="middle-row">
              <img :src="selectedRobot.left.src" class="rotate-left" alt="face/"/>
              <img :src="selectedRobot.torso.src" alt="face/"/>
              <img :src="selectedRobot.right.src" class="rotate-right" alt="face/"/>
            </div>
            <div class="bottom-row">
              <img :src="selectedRobot.base.src" alt="face/"/>
            </div>
          </div>
        </CollapsibleSection>
